...
- **Gemini CLI**: `gemini skills install https://github.com/Shirolin/i18n-agent-skill`

### 3. 更新技能 (Update)
推荐直接向 AI 助手发送指令进行热更新：
> **“/i18n-update”** 或 **“帮我更新 i18n 技能”**

或手动通过 CLI 覆盖安装：
```bash
gemini skills install https://github.com/Shirolin/i18n-agent-skill
```
